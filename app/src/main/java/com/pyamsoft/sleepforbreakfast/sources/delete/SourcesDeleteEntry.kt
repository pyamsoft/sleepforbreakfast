...
internal class SourcesDeleteInjector
@Inject
internal constructor(
    private val params: SourcesDeleteParams,
) : ComposableInjector() {

  @JvmField @Inject internal var viewModel: SourcesDeleteViewModeler? = null
