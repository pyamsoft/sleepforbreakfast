...
@Stable interface CategoryDeleteViewState : DeleteViewState<DbCategory>

@Stable
class MutableCategoryDeleteViewState @Inject internal constructor() :
    CategoryDeleteViewState, MutableDeleteViewState<DbCategory>()
