...
internal constructor(
  ...
  private val queryByIdCache =
      multiCachify<QueryByIdKey, Maybe<out DbSource>, DbSource.Id> { id ->
        Enforcer.assertOffMainThread()
  ...
  override suspend fun invalidateById(id: DbSource.Id) =
      withContext(context = Dispatchers.IO) {
        Enforcer.assertOffMainThread()
  ...
  override suspend fun queryById(id: DbSource.Id): Maybe<out DbSource> =
      withContext(context = Dispatchers.IO) {
        Enforcer.assertOffMainThread()
