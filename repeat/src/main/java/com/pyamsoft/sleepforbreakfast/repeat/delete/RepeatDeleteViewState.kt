...
@Stable interface RepeatDeleteViewState : DeleteViewState<DbRepeat>

@Stable
class MutableRepeatDeleteViewState @Inject internal constructor() :
    RepeatDeleteViewState, MutableDeleteViewState<DbRepeat>()
