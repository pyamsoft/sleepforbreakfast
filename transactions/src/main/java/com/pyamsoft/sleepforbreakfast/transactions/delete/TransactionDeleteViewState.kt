...
@Stable
interface TransactionDeleteViewState : UiViewState {
  val working: StateFlow<Boolean>
  val transaction: StateFlow<DbTransaction?>
}

@Stable
class MutableTransactionDeleteViewState @Inject internal constructor() :
    TransactionDeleteViewState {
  override val working = MutableStateFlow(false)
  override val transaction = MutableStateFlow<DbTransaction?>(null)
}
